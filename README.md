...
- [seismic-zfp](https://github.com/equinor/seismic-zfp) - ![Python](media/icon/python.png) Convert SEG-Y / ZGY files to compressed cubes and retrieve arbitrary sub-volumes from these, fast.
